...
namespace Mongoizer.Tests {
    ...
    public class MongoRepositoryTests : TestClassBase {
        ...
        private readonly MongoRepository<MockDocument> _mockRepo;
        ...
        public MongoRepositoryTests() {
            ...
            _mockRepo = new MongoRepository<MockDocument>(database);
        }
        ...
        public async Task CreateAsyncByItemShouldSucceed() {
            await _mockRepo.CreateAsync(_mockDocument98);

            var item = await _mockRepo.FindAsync(_mockDocument98.Id);
        ...
        public async Task CreateAsyncByExistingItemShouldFail() {
            var results1 = await _mockRepo.FindAsync();

            await _mockRepo.CreateAsync(_mockDocument98);
            var results2 = await _mockRepo.FindAsync();
        ...
        public async Task CreateAsyncByItemsShouldSucceed() {
            var deleteCount = await _mockRepo.DeleteAsync(x => true);
            var items = new List<MockDocument> {_mockDocument98, _mockDocument99};
            await _mockRepo.CreateAsync(items);

            var results = await _mockRepo.FindAsync();
        ...
        public async Task FindAsyncShouldSucceed() {
            var items = await _mockRepo.FindAsync();
        ...
        public async Task FindAsyncByIdShouldSucceed() {
            var item1 = await _mockRepo.FindAsync(_mockDocument98.Id);
            var item2 = await _mockRepo.FindAsync("xyz");
        ...
        public async Task FindAsyncByEmptyIdShouldThrow() => await Assert.ThrowsAsync<ArgumentException>(
            async delegate { await _mockRepo.FindAsync(""); });

        [Fact]
        [TestPriority(23)]
        public async Task FindAsyncByFilterShouldSucceed() {
            var items1 = await _mockRepo.FindAsync();
            var items2 = await _mockRepo.FindAsync(Builders<MockDocument>.Filter.Eq("isActive", false));
            var items3 = await _mockRepo.FindAsync(Builders<MockDocument>.Filter.Eq("name", "xyz"));
        ...
        public async Task FindAsyncByNullFilterShouldThrow() => await Assert.ThrowsAsync<ArgumentNullException>(
            async delegate { await _mockRepo.FindAsync((FilterDefinition<MockDocument>)null); });

        [Fact]
        [TestPriority(25)]
        public async Task FindAsyncByPredicateShouldSucceed() {
            var items1 = await _mockRepo.FindAsync();
            var items2 = await _mockRepo.FindAsync(x => x.IsActive);
            var items3 = await _mockRepo.FindAsync(x => x.Name == "xyz");
        ...
        public async Task FindAsyncByNullPredicateShouldThrow() => await Assert.ThrowsAsync<ArgumentNullException>(
            async delegate { await _mockRepo.FindAsync((Expression<Func<MockDocument, bool>>)null); });
        #endregion
        ...
        public async Task ReplaceAsyncByIdAndItemShouldSucceed() {
            var item1 = await _mockRepo.FindAsync(_mockDocument98.Id);
            var item2 = await _mockRepo.FindAsync(_mockDocument99.Id);
            ...
            var updatedItem1 = await _mockRepo.FindAsync(item1.Id);
            var updatedItem2 = await _mockRepo.FindAsync(item2.Id);
        ...
        public async Task UpdateAsyncByIdAndUpdateDefinitionShouldSucceed() {
            ...
            var updateResult1 = await _mockRepo.UpdateAsync(item1.Id, Builders<MockDocument>.Update.Set("updateDate", utcNow).Set("isActive", false));
            var updateResult2 = await _mockRepo.UpdateAsync(item2.Id, Builders<MockDocument>.Update.Set("updateDate", utcNow).Set("isActive", false));
        ...
        public async Task UpdateAsyncByNonExistingIdAndUpdateDefinitionShouldFail() {
            var updateResult = await _mockRepo.UpdateAsync("0", Builders<MockDocument>.Update.Set("updateDate", DateTime.UtcNow).Set("isActive", false));
        ...
        public async Task UpdateAsyncByIdsAndUpdateDefinitionShouldSucceed() {
            ...
            var count = await _mockRepo.UpdateAsync(ids, Builders<MockDocument>.Update.Set("value", value).Set("updateDate", utcNow));
            items = await _mockRepo.FindAsync();
        ...
        public async Task UpdateAsyncByNonExistingIdsAndUpdateDefinitionShouldFail() {
            var count = await _mockRepo.UpdateAsync(new List<string>{"xyz"}, Builders<MockDocument>.Update.Set("updateDate", DateTime.UtcNow).Set("isActive", false));
        ...
        public async Task UpdateAsyncByEmptyIdsAndUpdateDefinitionShouldThrow() => await Assert.ThrowsAsync<ArgumentException>(
            async delegate { await _mockRepo.UpdateAsync(new List<string>(), null); });
        ...
        public async Task UpdateAsyncByPredicateAndUpdateDefinitionShouldSucceed() {
            ...
            var count = await _mockRepo.UpdateAsync(x => !x.IsActive, Builders<MockDocument>.Update.Set("value", value));
            var items = await _mockRepo.FindAsync();
        ...
        public async Task UpdateAsyncByNonExistingPredicateAndUpdateDefinitionShouldFail() {
            var count = await _mockRepo.UpdateAsync(x => x.Id == "xyz", Builders<MockDocument>.Update.Set("value", "corrected value #2"));
        ...
        public async Task UpdateAsyncByNullPredicateAndUpdateDefinitionShouldThrow() => await Assert.ThrowsAsync<ArgumentNullException>(
            async delegate { await _mockRepo.UpdateAsync((Expression<Func<MockDocument, bool>>)null, null); });
        ...
        public async Task UpdateAsyncByPredicateAndNullUpdateDefinitionShouldThrow() => await Assert.ThrowsAsync<ArgumentNullException>(
            async delegate { await _mockRepo.UpdateAsync(x => !string.IsNullOrWhiteSpace(x.Id), null); });
        #endregion
        ...
        public async Task DeleteAsyncByIdShouldSucceed() {
            var deleteResult1 = await _mockRepo.DeleteAsync(_mockDocument98.Id);
            var deleteResult2 = await _mockRepo.DeleteAsync(_mockDocument99.Id);
        ...
        public async Task DeleteAsyncByNonExistingIdShouldFail() {
            var deleteResult = await _mockRepo.DeleteAsync("xyz");
        ...
        public async Task DeleteAsyncByIdsShouldSucceed() {
            ...
            var deleteCount = await _mockRepo.DeleteAsync(ids);
            results = await _mockRepo.FindAsync();
        ...
        public async Task DeleteAsyncByNonExistingIdsShouldFail() {
            var deleteCount = await _mockRepo.DeleteAsync(new List<string>{"xyz"});
        ...
        public async Task DeleteAsyncByPredicateShouldSucceed() {
            ...
            var searchResults = await _mockRepo.FindAsync();
            var count = searchResults.Count;

            var deleteCount = await _mockRepo.DeleteAsync(x => !x.IsActive);
            searchResults = await _mockRepo.FindAsync();
        ...
        public async Task DeleteAsyncByNonExistingPredicateShouldFail() {
            var deleteCount = await _mockRepo.DeleteAsync(x => x.Id == "xyz");
        ...
        public async Task DeleteAsyncByNullDescriptorShouldThrow() => await Assert.ThrowsAsync<ArgumentNullException>(
            async delegate { await _mockRepo.DeleteAsync((Expression<Func<MockDocument, bool>>)null); });
        #endregion
    }
}
